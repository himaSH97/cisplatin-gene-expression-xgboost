...
- **Wide feature space**: 41,000+ gene columns with inconsistent naming
...
![ROC Curve](data/plots/roc.png)

#### Classification Threshold Analysis

![Classification Threshold](data/plots/classificarion%20threshold.png)
...
![Feature Importance](data/plots/output.png)
